...
```bash
$ git clone git@github.com:maspeng/docker-hub-travis-cli.git
```

- Or via HTTPS:

```bash
$ git clone https://github.com/maspeng/docker-hub-travis-cli.git
```
...
2. Fork the repository (http://github.com/maspeng/docker-hub-travis-cli)
3. Clone the canonical repository locally and enter it.

```bash
$ git clone git://github.com/maspeng/docker-hub-travis-cli.git
$ cd docker-hub-travis-cli
```

4. Add a remote to your fork; substitute your GitHub username in the command below.

```bash
$ git remote add {username} git@github.com:{username}/docker-hub-travis-cli.git
$ git fetch {username}
```
...
To ssh://git@github.com/{username}/docker-hub-travis-cli.git
